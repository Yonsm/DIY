...
iface = IFACES.dev_from_pcapname(pcapname(interface)) if interface else conf.iface

def mysend(pay,interface = iface):
    sendp(pay, iface = iface)
